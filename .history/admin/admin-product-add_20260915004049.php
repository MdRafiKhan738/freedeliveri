...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    */
    if ($error === "") {
        ...
        /*
         * product_image = নতুন upload field
         */
...
<div class="page">
    ...
    <form method="post" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="card">
            ...
            <p class="section-help">
                Product image সরাসরি MySQL-এ save হবে। JPG, PNG এবং WEBP
                format support করে। Maximum 5MB।
            </p>
            ...
            <div class="image-upload" id="imageDropArea">
                ...
                <div class="help" style="margin-bottom:13px;">
                    Select one product image from your phone/computer.
                </div>
            ...
            <div class="help" style="margin-top:10px;">
                Recommended: পরিষ্কার product photo ব্যবহার করুন। Upload করলে
                MySQL-এ save করার আগে image type এবং size যাচাই করা হবে।
            </div>
        </div>
